...
include("config.php");
$usn=$_POST['usn'];
$x=mysqli_query($al,"SELECT * FROM students WHERE usn='$usn'");
$y=mysqli_fetch_array($x);
$sem=$y['sem'];
$name=$y['name'];
$a=mysqli_query($al,"SELECT * FROM marks WHERE usn='$usn' AND sem='$sem'");
...
<span class="labels" style="color:#C9F;">Name : <?php echo $name;?><br>USN No.: <?php echo $usn;?><br>Semester : <?php echo $sem;?></span>
