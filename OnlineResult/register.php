...
if($usn==NULL || $sem==NULL || $email==NULL || $nam==NULL)
{
	//
}
else
{
	$sql=mysqli_query($al,"INSERT INTO students(name,usn,sem,email) VALUES('$nam','$usn','$sem','$email')");
	if($sql)
	{
...
<tr><td class="labels">USN No.:</td><td><input type="text" name="usn" class="fields" required="required" size="15" placeholder="Enter USN No." /></td></tr>
